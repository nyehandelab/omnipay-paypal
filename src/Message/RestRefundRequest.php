...
use Omnipay\PayPal\Message\RestRefundRequest as RestV1RefundRequest;

class RestRefundRequest extends RestV1RefundRequest {
    ...
    public function getEndpoint(): string {
        ...
        return $base . '/payments/captures/' . $this->getTransactionReference() . '/refund';
    }
}
